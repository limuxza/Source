...
function Linux.Create(config)
    ...
    local ToggleButton = Linux.Instance("Frame", {
        Parent = LinuxUI,
        BackgroundColor3 = Color3.fromRGB(18, 18, 18),
        BorderColor3 = Color3.fromRGB(39, 39, 42),
    ...
    local ToggleIcon = Linux.Instance("ImageLabel", {
        Parent = ToggleButton,
        BackgroundTransparency = 1,
    ...
    local ToggleClickButton = Linux.Instance("TextButton", {
        Parent = ToggleButton,
        BackgroundTransparency = 1,
        Size = UDim2.new(1, 0, 1, 0),
        Text = "",
    ...
    ToggleClickButton.MouseEnter:Connect(function()
        TweenService:Create(ToggleIcon, TweenInfo.new(0.2), {ImageColor3 = Color3.fromRGB(255, 255, 255)}):Play()
    ...
    ToggleClickButton.MouseLeave:Connect(function()
        TweenService:Create(ToggleIcon, TweenInfo.new(0.2), {ImageColor3 = Color3.fromRGB(200, 200, 210)}):Play()
        TweenService:Create(ToggleButton, TweenInfo.new(0.2), {BackgroundTransparency = 0.05}):Play()
    end)
    
    ToggleClickButton.MouseButton1Click:Connect(function()
        isUIVisible = not isUIVisible
        
        local scaleInfo = TweenInfo.new(0.15, Enum.EasingStyle.Back, Enum.EasingDirection.Out)
        TweenService:Create(ToggleButton, scaleInfo, {Size = UDim2.new(0, 45, 0, 45)}):Play()
        
        task.wait(0.15)
        
        TweenService:Create(ToggleButton, scaleInfo, {Size = UDim2.new(0, 50, 0, 50)}):Play()
    ...
    function LinuxLib.Tab(config)
        ...
        function TabElements.Button(config)
            ...
            local Btn = Linux.Instance("TextButton", {
                Parent = BtnFrame,
                BackgroundTransparency = 1,
                Size = UDim2.new(1, -20, hasDescription and 0.7 or 1, 0),
                Position = UDim2.new(0, 10, 0, 0),
                Font = Enum.Font.GothamSemibold,
                Text = config.Name,
                TextColor3 = Color3.fromRGB(200, 200, 210),
